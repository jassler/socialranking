...
There is a small caveat to Definition `r refDef("def:ks")`. For one, it compares the number of strict relation By default this function does not compare $d_{ii}(\succsim)$. In other terms,
